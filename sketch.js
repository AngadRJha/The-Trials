...
var HighScoreLoad,HighScore
var crashScore="loading...."
...
function preload(){
  ...
  HighScoreLoad=loadImage("HighScore.png")
}
...
function setup() {
  ...
  Life1=createSprite(700,5,20,20)
  Life1.addImage(Life1Load);
  Life1.scale=0.2
  
  Life2=createSprite(740,5,20,20)
  Life2.addImage(Life1Load);
  Life2.scale=0.2

  Life3=createSprite(780,5,20,20)
...
function getCrashScore(){
  var crashScoreRef=database.ref('crashScore')
  crashScoreRef.on("value",function(data){
    crashScore=data.val()
  })
}
